...
$english = array(
		...
		'veeplay:effect:desc' => "Graphic effects are available for the audio player, a Visualization effect and an Equalizer effect. Only one of these can be set at a time. The effects can be set independently from the player size. This means it is possible to set the effects on with a minimized control bar. If you set the set the control bar to minimum height (23), switch off effects to save bandwidth.",
		...
		// Sharing
		'veeplay:share:share' => "Select share function ON or OFF. This affects both the audio and video player simultaneously:",
