 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td><input type="checkbox" readonly disabled="disabled" name="enable_paypal" size="40" value="1" checked /></td>
        </tr>    
        ...
        <td><input type="text" name="currency" value="<?php echo esc_attr(cp_contactformpp_get_option('currency',CP_CONTACTFORMPP_DEFAULT_CURRENCY)); ?>" /></td>
        </tr>
